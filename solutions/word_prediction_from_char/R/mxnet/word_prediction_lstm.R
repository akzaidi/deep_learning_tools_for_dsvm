...
# Training and evaluate data
root_path <- c("../../data/")
data_path <- file.path(root_path, "tiny_shakespeare.txt")
ret <- make.data(data_path, seq.len=seq.len)
X <- ret$data
dic <- ret$dic
...
# Inference from model and help functions
